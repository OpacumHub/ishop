...
if (!$arResult['EMPTY_BASKET']) {
    ...
    <div class="cart-empty">
        <div class="attention">
            ...
            <p>
                Выбирайте товары, кладите их в корзину, и возвращайтесь сюда для оформления заказа.
            </p>
            <a href="/about/how_to_register/">Как зарегестрироваться</a>
            <a href="/about/delivery/">Оплата</a>
            <a href="/about/delivery/">Доставка</a>
            <a href="/about/delivery/">Самовывоз</a>
        </div>
        <a href="/" class="btn btn--border btn--back">
